...
file_handle_construction_params = [
    ...
    (
        FILE_TYPE.DATABASE,
        os.path.join(DB_FILES, "does_not_exist.sqlite"),
        None,
        None,
        IO_ERROR,
    ),
    (
        FILE_TYPE.DATABASE,
        os.path.join(DB_FILES, "inaccessible.sqlite"),
        None,
        None,
        VALUE_ERROR,
    ),
    ...
    (
        FILE_TYPE.DATABASE,
        os.path.join(DB_FILES, "invalid_database.sqlite"),
        None,
        None,
        HEADER_ERROR,
    ),
    (
        FILE_TYPE.WAL,
        os.path.join(DB_FILES, "invalid_wal.sqlite-wal"),
        None,
        None,
        VALUE_ERROR,
    ),
    (
        FILE_TYPE.ROLLBACK_JOURNAL,
        os.path.join(DB_FILES, "invalid_journal.sqlite-journal"),
        None,
        None,
        VALUE_ERROR,
    ),
    (
        FILE_TYPE.WAL_INDEX,
        os.path.join(DB_FILES, "invalid_wal_index.sqlite-shm"),
        None,
        None,
        VALUE_ERROR,
    ),
    ...
    (
        FILE_TYPE.WAL_INDEX,
        os.path.join(DB_FILES, "chinook.sqlite-shm"),
        None,
        None,
        FileHandle(
            FILE_TYPE.WAL_INDEX,
    ...
    (
        FILE_TYPE.ROLLBACK_JOURNAL,
        os.path.join(DB_FILES, "chinook.sqlite-journal"),
        None,
        None,
        FileHandle(
            FILE_TYPE.ROLLBACK_JOURNAL,
