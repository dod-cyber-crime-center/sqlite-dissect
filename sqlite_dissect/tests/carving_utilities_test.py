...
from sqlite_dissect.carving.utilities import (
    ...
    calculate_serial_type_varint_length_min_max,
    decode_varint_in_reverse,
    generate_regex_for_simplified_serial_type,
    generate_signature_regex,
    get_content_size,
)
...
def test_calculate_serial_type_definition_content_length_min_max():
    ...
    assert calculate_serial_type_definition_content_length_min_max(None, 9) == (
        0,
        content_max_length,
    )
    assert calculate_serial_type_definition_content_length_min_max(test_list, 9) == (
        0,
        content_max_length,
    )
