...
from sqlite_dissect.constants import (
    ...
    WAL_INDEX_FILE_FORMAT_VERSION,
    WAL_INDEX_HEADER_LENGTH,
    WAL_INDEX_LOCK_RESERVED_LENGTH,
    WAL_INDEX_NUMBER_OF_FRAMES_BACKFILLED_IN_DATABASE_LENGTH,
    WAL_INDEX_NUMBER_OF_SUB_HEADERS,
    WAL_INDEX_READER_MARK_LENGTH,
    WAL_INDEX_READER_MARK_SIZE,
