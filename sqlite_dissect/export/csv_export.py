...
class VersionCsvExporter:
    ...
    def _write_b_tree_index_leaf_records(
        ...
        if logger.isEnabledFor(DEBUG):
            for cell in cells.values():
                ...
                log_message = (
                    "File source: {} version: {} page version: {} cell source: {} page: {} located: {} "
    ...
    def _write_b_tree_table_leaf_records(
        ...
        if logger.isEnabledFor(DEBUG):
            for cell in sorted_cells:
                ...
                log_message = (
                    "File source: {} version: {} page version: {} cell source: {} page: {} location: {} "
    ...
    def _write_b_tree_table_master_schema_carved_records(
        ...
        for carved_cell in carved_cells:
            ...
            row = [
                version.file_type,
                carved_cell.version_number,
                carved_cell.page_version_number,
                carved_cell.source,
                carved_cell.page_number,
                carved_cell.location,
                True,
                "Unknown",
        ...
        if logger.isEnabledFor(DEBUG):
            for carved_cell in carved_cells:
                ...
                log_message = (
                    "File source: {} version: {} version number: {} cell source: {} page: {} location: {} "
                    "carved: {} status: {} at file offset: {}"
                )
                log_message = log_message.format(
                    version.file_type,
    ...
    def write_commit(self, master_schema_entry, commit):
        ...
        if not csv_file_name:
            ...
            csv_file_name = os.path.join(
                ...
                (self._file_name_prefix + "-" + commit_name + ".csv"),
            )
