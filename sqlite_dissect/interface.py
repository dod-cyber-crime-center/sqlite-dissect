...
def get_version_history_iterator(
    ...
    return VersionHistoryParser(
        version_history,
        master_schema_entries[table_or_index_name],
        None,
        None,
        signature,
...
def export_table_or_index_version_history_to_csv(
    csv_file_name,
    export_directory,
    version_history,
    table_or_index_name,
...
def export_version_history_to_csv(
    csv_file_name,
    export_directory,
    version_history,
    signatures=None,
...
def export_version_history_to_sqlite(
    export_directory,
    sqlite_file_name,
    version_history,
    signatures=None,
